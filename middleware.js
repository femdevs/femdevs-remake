...
const headers = CORS.Headers({
    ...
    PermissionPolicy: CORS.WebSecurity.PermissionPolicy(
        ...
        new CORS.PermissionPolicy('microphone', { self: true, domains: WebSecurity.CD('thefemdevs.com') }),
        new CORS.PermissionPolicy('storageAccess', { self: true, domains: WebSecurity.CD('thefemdevs.com') }),
        new CORS.PermissionPolicy('otpCredentials', { self: true, domains: WebSecurity.CD('thefemdevs.com') }),
        new CORS.PermissionPolicy('pictureInPicture', { self: true, domains: WebSecurity.CD('thefemdevs.com') }),
        new CORS.PermissionPolicy('speakerSelection', { self: true, domains: WebSecurity.CD('thefemdevs.com') }),
        new CORS.PermissionPolicy('identityCredentialsGet', { self: true, domains: WebSecurity.CD('thefemdevs.com') }),
        new CORS.PermissionPolicy('publickeyCredentialsGet', { self: true, domains: WebSecurity.CD('thefemdevs.com') }),
        new CORS.PermissionPolicy('publickeyCredentialsCreate', { self: true, domains: WebSecurity.CD('thefemdevs.com') }),
        new CORS.PermissionPolicy('geolocation', { self: true, domains: ['googleapis.com', 'thefemdevs.com'].map(WebSecurity.CD) }),
        new CORS.PermissionPolicy('payment', { self: true, domains: [WebSecurity.CD('thefemdevs.com'), WebSecurity.CD('stripe.com')] }),
    ),
